...
//        return em.createQuery("SELECT t FROM bee_task t WHERE t.owner = ? AND LOWER(t.title) LIKE ?", Task.class)
...
//        return em.createQuery("SELECT t FROM bee_task t WHERE t.owner = ?", Task.class).setParameter(1, user);
//    }
}
